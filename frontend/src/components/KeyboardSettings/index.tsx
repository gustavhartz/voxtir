  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col pb-4">
        ...
        <span>Set specific keyboard keys to make your transcription faster. For example you can toggle play and pause of audio while you write with:
          <span className="font-semibold"> CMD + {playPause.toUpperCase()}</span></span>
      </div>
      ...
      <div className="shadow-md rounded-md bg-slate-50 p-3 mt-4">
        <div className="flex flex-row justify-between items-center">
          <h4 className="text-2xl font-semibold pb-2 text-black">Audio Volume</h4>
      ...
      <div className="shadow-md rounded-md bg-slate-50 p-3 mt-4">
        <div className="flex flex-row justify-between items-center">
          <h4 className="text-2xl font-semibold pb-2 text-black">Audio Track</h4>
